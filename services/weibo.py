...
"""
A weibo REST API client using oAuth 2.
Port to python3.

Original from https://raw.githubusercontent.com/michaelliao/sinaweibopy/master/weibo.py
by 'Liao Xuefeng (askxuefeng@gmail.com)'
...
import gzip, time, json, hmac, base64, hashlib
import urllib.request, urllib.parse, urllib.error, urllib.request, urllib.error, urllib.parse
import logging, mimetypes, collections
